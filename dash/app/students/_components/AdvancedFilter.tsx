...
import { BadgeCheck, Funnel, RotateCcw, SlidersHorizontal } from "lucide-react";
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
            ...
            <div className="flex items-center gap-2">
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    onClick={() => setOpen(false)}
                    className="gap-2  text-white transition-all duration-200 ease-out bg-[#31A8E0] hover:bg-[#1fa8bb] active:scale-[0.98] "
                  >
                    <Funnel className="h-4 w-4" />
                  </Button>
                </TooltipTrigger>
                <TooltipContent sideOffset={8}>
                  Сонгосон шүүлтүүдийг хэрэгжүүлнэ
                </TooltipContent>
              </Tooltip>
            </div>
          </div>
